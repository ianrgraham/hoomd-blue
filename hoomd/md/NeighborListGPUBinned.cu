...
inline void launcher(const hipStream_t& stream, unsigned int* d_nlist,
                     unsigned int* d_n_neigh,
                     Scalar4* d_last_updated_pos,
                     unsigned int* d_conditions,
                     const unsigned int* d_Nmax,
    ...
    if (tpp == cur_tpp && cur_tpp != 0)
        ...
        {
        launcher<cur_tpp / 2>(stream, d_nlist,
                              d_n_neigh,
                              d_last_updated_pos,
                              d_conditions,
                              d_Nmax,
...
template<>
inline void launcher<min_threads_per_particle / 2>(const hipStream_t& stream, unsigned int* d_nlist,
                                                   unsigned int* d_n_neigh,
                                                   Scalar4* d_last_updated_pos,
                                                   unsigned int* d_conditions,
                                                   const unsigned int* d_Nmax,
