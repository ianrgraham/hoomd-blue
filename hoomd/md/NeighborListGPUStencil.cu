...
inline void stencil_launcher(const hipStream_t& stream, unsigned int* d_nlist,
                             unsigned int* d_n_neigh,
                             Scalar4* d_last_updated_pos,
                             unsigned int* d_conditions,
                             const unsigned int* d_Nmax,
    ...
    if (threads_per_particle == cur_tpp && cur_tpp != 0)
        ...
        {
        stencil_launcher<cur_tpp / 2>(stream, d_nlist,
                                      d_n_neigh,
                                      d_last_updated_pos,
                                      d_conditions,
                                      d_Nmax,
...
template<>
inline void stencil_launcher<min_threads_per_particle / 2>(const hipStream_t& stream, unsigned int* d_nlist,
                                                           unsigned int* d_n_neigh,
                                                           Scalar4* d_last_updated_pos,
                                                           unsigned int* d_conditions,
                                                           const unsigned int* d_Nmax,
...
hipError_t gpu_compute_nlist_stencil(const hipStream_t& stream, unsigned int* d_nlist,
                                     ...
                                     const hipDeviceProp_t& devprop)
    {
    stencil_launcher<max_threads_per_particle>(stream, d_nlist,
                                               d_n_neigh,
                                               d_last_updated_pos,
                                               d_conditions,
                                               d_Nmax,
